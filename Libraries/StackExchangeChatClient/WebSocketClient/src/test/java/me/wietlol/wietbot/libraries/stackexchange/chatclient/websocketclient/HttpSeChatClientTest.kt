...
class HttpSeChatClientTest
{
	companion object
	{
		...
		fun main(args: Array<String>)
		{
			...
			val factory = HttpSeChatClientFactory(JacksonSerializerAdapter(ObjectMapper()), NoOpLogger())
//			val factory = HttpSeWebSocketClientFactory(
//				JacksonSerializerAdapter(ObjectMapper()),
//				NoOpLogger()
//			)
			val client = factory.create(credentials)
			
			client.sendMessage(1, "You feel an evil presence approaching you.")
